...
const Home: NextPage = () => {
  ...
  const bg =
    "https://www.shutterstock.com/shutterstock/photos/558786436/display_1500/stock-photo-photo-studio-with-modern-interior-and-lighting-equipment-558786436.jpg";
    ...
    <>
      ...
      <main>
        ...
        >
          ...
          <div className="hero-content w-5/6 flex-col gap-12 rounded-lg bg-white bg-opacity-70 p-8 sm:w-3/4 sm:p-16">
            ...
            {(!session || session?.role === "user") && (
              <>
                <p>
                  ...
                  Fugit iste explicabo earum delectus autem excepturi
                  dignissimos est perspiciatis ad aliquam? Maxime eius fugiat
                  laboriosam impedit iusto et autem doloribus animi?
                </p>
        ...
        <div className="mx-8 mt-8 flex flex-col sm:mx-12 md:mx-24 lg:mx-28 xl:mx-auto xl:max-w-6xl">
          ...
          <div className="carousel-center carousel rounded-box mb-8 space-x-4 bg-neutral p-4">
