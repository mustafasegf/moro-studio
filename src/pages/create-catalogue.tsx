...
export default function CreateCatalogue(){
  ...
  <h1 className="m-8 flex justify-center">Buat Paket Foto</h1>
    ...
    <form onSubmit={handleSubmitPaket}>
      <div className="overflow-hidden shadow sm:rounded-md">
        <div className="bg-white px-4 py-5 sm:p-6">
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <select id="durasi" name="durasi" className="mt-2 block w-full rounded-md border-0 bg-white py-1.5 pl-2.5 pr-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={(e) => setDurasi(e.target.value)}>
            ...
            <div className="col-span-6">
              ...
              <div className="mt-2">
                <textarea id="deskripsi" name="deskripsi" rows={5} className="mt-1 block w-full rounded-md border-0 py-1.5 pl-2.5 pr-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6" placeholder="deskripsi paket foto" onChange={(e) => setDeskripsi(e.target.value)}></textarea>
              </div>
            </div>              
          </div>
        </div>
        ...
        <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
          <Link href="/" type="button" className="inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mr-3 sm:w-auto">Kembali</Link>
