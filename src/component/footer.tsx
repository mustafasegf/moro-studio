...
export function Footer() {
  return (
    <footer className="footer bg-dark-grey p-8 text-base-content md:grid-cols-4">
      ...
      <div className="mr-5 md:mt-3">
        <span className="font-bold text-white-grey">Moro Studio Jogja</span>
        <p className="text-white-grey">
          Jl. Demangan Baru, Mrican, Caturtunggal, Kec. Depok, Kabupaten Sleman,
          Daerah Istimewa Yogyakarta 55281
        </p>
      </div>
      <div className="mr-5 md:mt-3">
        <span className="font-bold text-white-grey">Moro Studio Solo</span>
        <p className="text-white-grey">
